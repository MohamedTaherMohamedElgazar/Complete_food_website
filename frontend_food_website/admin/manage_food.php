...
<!--menu section ends here-->
    ...
    <div class="main_content">
        ...
        if(isset($_SESSION['neww_update'])){
            echo $_SESSION['neww_update'];
            unset($_SESSION['neww_update']);
        };
                            ...
                            while($row = mysqli_fetch_array($result)){
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn-secondary" href="<?php echo SITEURL;?>admin/update_food.php?id=<?php echo $id;?>&image_name=<?php echo $image; ?>">Update food</a>
