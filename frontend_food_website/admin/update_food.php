...
if(isset($_POST['update_food'])){
    ...
    $sql = "UPDATE tbl_food SET title='$title',description='$description',price='$price',image_name='$imagey_name',featured='$featured',active='$active' WHERE id=$id";

    $result101 = mysqli_query($conn,$sql);
    if($result101){
        $_SESSION['neww_update'] = "<div class='success>food is update successfully</div>";
        header("Location:".SITEURL."/admin/manage_food.php");
    }
